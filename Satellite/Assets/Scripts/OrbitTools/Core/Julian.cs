...
namespace Zeptomoby.OrbitTools
{
   ...
   public class Julian
   {
      ...
      public void AddDay(double day) { m_Date += day; }
      public void AddHour(double hr) { m_Date += (hr  / Globals.HoursPerDay); }
      public void AddMin(double min) { m_Date += (min / Globals.MinPerDay); }
      public void AddSec(double sec) { m_Date += (sec / Globals.SecPerDay); }
